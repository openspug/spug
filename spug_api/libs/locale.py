...
MESSAGES = {
    ...
    '未配置推送对象ID，请在账户管理中配置后再使用MFA认证。': 'No push target ID configured, please set it in Account Management before using MFA.',
    ...
    '未配置邮件服务，请在系统设置/报警服务设置中配置后再测试。': 'The mail service is not configured, please set it in System Settings / Alert Service before testing.',
    '未绑定推送助手账户，请在系统管理/系统设置/推送服务设置中绑定后再使用MFA认证。': 'The Push Assistant account is not bound, please bind it in System / System Settings / Push Service before using MFA.',
